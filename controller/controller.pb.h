...
#ifndef github_2ecom_2faperturerobotics_2fcontrollerbus_2fcontroller_2fcontroller_2eproto_2epb_2eh
#define github_2ecom_2faperturerobotics_2fcontrollerbus_2fcontroller_2fcontroller_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_github_2ecom_2faperturerobotics_2fcontrollerbus_2fcontroller_2fcontroller_2eproto
...
struct TableStruct_github_2ecom_2faperturerobotics_2fcontrollerbus_2fcontroller_2fcontroller_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_github_2ecom_2faperturerobotics_2fcontrollerbus_2fcontroller_2fcontroller_2eproto;
}  // extern "C"
...
/* @@protoc_insertion_point(class_definition:controller.Info) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "controller.Info"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:controller.Info)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_github_2ecom_2faperturerobotics_2fcontrollerbus_2fcontroller_2fcontroller_2eproto;
};
...
inline const ::std::string& Info::id() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:controller.Info.id)
  return _internal_id();
}
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void Info::set_id(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  _impl_.id_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:controller.Info.id)
}
inline ::std::string* PROTOBUF_NONNULL Info::mutable_id()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  ::std::string* _s = _internal_mutable_id();
  // @@protoc_insertion_point(field_mutable:controller.Info.id)
  return _s;
}
...
inline ::std::string* PROTOBUF_NONNULL Info::_internal_mutable_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.id_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE Info::release_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:controller.Info.id)
...
inline void Info::set_allocated_id(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  } else {
  ...
  // @@protoc_insertion_point(field_set_allocated:controller.Info.id)
}
...
inline const ::std::string& Info::version() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:controller.Info.version)
...
PROTOBUF_ALWAYS_INLINE void Info::set_version(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:controller.Info.version)
}
inline ::std::string* PROTOBUF_NONNULL Info::mutable_version()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000002U);
  ::std::string* _s = _internal_mutable_version();
  // @@protoc_insertion_point(field_mutable:controller.Info.version)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Info::release_version() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:controller.Info.version)
...
inline void Info::set_allocated_version(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:controller.Info.version)
}
...
inline const ::std::string& Info::description() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:controller.Info.description)
...
PROTOBUF_ALWAYS_INLINE void Info::set_description(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:controller.Info.description)
}
inline ::std::string* PROTOBUF_NONNULL Info::mutable_description()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000004U);
  ::std::string* _s = _internal_mutable_description();
  // @@protoc_insertion_point(field_mutable:controller.Info.description)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Info::release_description() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:controller.Info.description)
...
inline void Info::set_allocated_description(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:controller.Info.description)
}
...
#endif  // github_2ecom_2faperturerobotics_2fcontrollerbus_2fcontroller_2fcontroller_2eproto_2epb_2eh
