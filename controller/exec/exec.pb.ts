...
function createBaseExecControllerRequest(): ExecControllerRequest {
  return { configSet: undefined, configSetYaml: "", configSetYamlOverwrite: false };
}

export const ExecControllerRequest = {
  encode(message: ExecControllerRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExecControllerRequest {
  ...
  fromJSON(object: any): ExecControllerRequest {
    return {
      configSet: isSet(object.configSet) ? ConfigSet.fromJSON(object.configSet) : undefined,
      configSetYaml: isSet(object.configSetYaml) ? String(object.configSetYaml) : "",
      configSetYamlOverwrite: isSet(object.configSetYamlOverwrite) ? Boolean(object.configSetYamlOverwrite) : false,
    };
  },
  ...
  toJSON(message: ExecControllerRequest): unknown {
    ...
    message.configSet !== undefined &&
      (obj.configSet = message.configSet ? ConfigSet.toJSON(message.configSet) : undefined);
    message.configSetYaml !== undefined && (obj.configSetYaml = message.configSetYaml);
    message.configSetYamlOverwrite !== undefined && (obj.configSetYamlOverwrite = message.configSetYamlOverwrite);
    return obj;
  },
...
export const ExecControllerResponse = {
  encode(message: ExecControllerResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExecControllerResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ExecControllerResponse {
    return {
      ...
      status: isSet(object.status) ? controllerStatusFromJSON(object.status) : 0,
  ...
  toJSON(message: ExecControllerResponse): unknown {
    ...
    message.status !== undefined && (obj.status = controllerStatusToJSON(message.status));
