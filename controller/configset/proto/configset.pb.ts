...
export const ConfigSet = {
  encode(message: ConfigSet, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.configurations).forEach(([key, value]) => {
      ConfigSet_ConfigurationsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConfigSet {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          const entry1 = ConfigSet_ConfigurationsEntry.decode(reader, reader.uint32());
  ...
  async *encodeTransform(
    source: AsyncIterable<ConfigSet | ConfigSet[]> | Iterable<ConfigSet | ConfigSet[]>,
  ...
  fromJSON(object: any): ConfigSet {
    return {
      configurations: isObject(object.configurations)
        ? Object.entries(object.configurations).reduce<{ [key: string]: ControllerConfig }>((acc, [key, value]) => {
...
export const ConfigSet_ConfigurationsEntry = {
  encode(message: ConfigSet_ConfigurationsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConfigSet_ConfigurationsEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<ConfigSet_ConfigurationsEntry | ConfigSet_ConfigurationsEntry[]>
      | Iterable<ConfigSet_ConfigurationsEntry | ConfigSet_ConfigurationsEntry[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
...
export const ControllerConfig = {
  ...
  async *encodeTransform(
    source: AsyncIterable<ControllerConfig | ControllerConfig[]> | Iterable<ControllerConfig | ControllerConfig[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  toJSON(message: ControllerConfig): unknown {
    ...
    message.revision !== undefined && (obj.revision = (message.revision || Long.UZERO).toString());
