...
export const DirectiveInfo = {
  encode(message: DirectiveInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.debugVals.push(ProtoDebugValue.decode(reader, reader.uint32()));
          break;
        default:
  ...
  async *encodeTransform(
    source: AsyncIterable<DirectiveInfo | DirectiveInfo[]> | Iterable<DirectiveInfo | DirectiveInfo[]>,
  ...
  fromJSON(object: any): DirectiveInfo {
    return {
      ...
      debugVals: Array.isArray(object?.debugVals) ? object.debugVals.map((e: any) => ProtoDebugValue.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: DirectiveInfo): unknown {
    ...
    if (message.debugVals) {
      obj.debugVals = message.debugVals.map((e) => e ? ProtoDebugValue.toJSON(e) : undefined);
    } else {
      obj.debugVals = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<DirectiveInfo>, I>>(object: I): DirectiveInfo {
    ...
    message.debugVals = object.debugVals?.map((e) => ProtoDebugValue.fromPartial(e)) || [];
    return message;
  },
};
...
export const DirectiveState = {
  encode(message: DirectiveState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<DirectiveState | DirectiveState[]> | Iterable<DirectiveState | DirectiveState[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): DirectiveState {
    return { info: isSet(object.info) ? DirectiveInfo.fromJSON(object.info) : undefined };
  },
...
export const ProtoDebugValue = {
  encode(message: ProtoDebugValue, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  async *encodeTransform(
    source: AsyncIterable<ProtoDebugValue | ProtoDebugValue[]> | Iterable<ProtoDebugValue | ProtoDebugValue[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
