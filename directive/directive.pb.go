...
func (m *DirectiveInfo) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (m *DirectiveState) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (m *ProtoDebugValue) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (m *DirectiveInfo) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: DirectiveInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: DirectiveInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field DebugVals", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *DirectiveState) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: DirectiveState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: DirectiveState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field Info", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ProtoDebugValue) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: ProtoDebugValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: ProtoDebugValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
