...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      busApiConfig: isSet(object.busApiConfig) ? Config1.fromJSON(object.busApiConfig) : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.busApiConfig !== undefined &&
      (obj.busApiConfig = message.busApiConfig ? Config1.toJSON(message.busApiConfig) : undefined);
    return obj;
  },
