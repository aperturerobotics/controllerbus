...
type SRPCControllerBusServiceClient interface {
	...
	ExecController(ctx context.Context, in *controller_exec.ExecControllerRequest) (SRPCControllerBusService_ExecControllerClient, error)
}
...
func (c *srpcControllerBusServiceClient) ExecController(ctx context.Context, in *controller_exec.ExecControllerRequest) (SRPCControllerBusService_ExecControllerClient, error) {
...
func (x *srpcControllerBusService_ExecControllerClient) Recv() (*controller_exec.ExecControllerResponse, error) {
...
func (x *srpcControllerBusService_ExecControllerClient) RecvTo(m *controller_exec.ExecControllerResponse) error {
	return x.MsgRecv(m)
}
...
type SRPCControllerBusServiceServer interface {
	...
	// ExecController executes a controller configuration on the bus.
	ExecController(*controller_exec.ExecControllerRequest, SRPCControllerBusService_ExecControllerStream) error
}
...
func (x *srpcControllerBusService_ExecControllerStream) Send(m *controller_exec.ExecControllerResponse) error {
	return x.MsgSend(m)
}

func (x *srpcControllerBusService_ExecControllerStream) SendAndClose(m *controller_exec.ExecControllerResponse) error {
	if m != nil {
