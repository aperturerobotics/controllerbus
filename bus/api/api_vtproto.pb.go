...
func (c *controllerBusServiceClient) ExecController(ctx context.Context, in *exec.ExecControllerRequest, opts ...grpc.CallOption) (ControllerBusService_ExecControllerClient, error) {
	stream, err := c.cc.NewStream(ctx, &ControllerBusService_ServiceDesc.Streams[0], "/bus.api.ControllerBusService/ExecController", opts...)
	if err != nil {
		return nil, err
	}
...
// All implementations must embed UnimplementedControllerBusServiceServer
...
type ControllerBusServiceServer interface {
	...
	mustEmbedUnimplementedControllerBusServiceServer()
}
...
func (UnimplementedControllerBusServiceServer) mustEmbedUnimplementedControllerBusServiceServer() {}

// UnsafeControllerBusServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ControllerBusServiceServer will
...
func RegisterControllerBusServiceServer(s grpc.ServiceRegistrar, srv ControllerBusServiceServer) {
	s.RegisterService(&ControllerBusService_ServiceDesc, srv)
}
...
// ControllerBusService_ServiceDesc is the grpc.ServiceDesc for ControllerBusService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ControllerBusService_ServiceDesc = grpc.ServiceDesc{
...
func (m *GetBusInfoResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RunningDirectives) > 0 {
		for iNdEx := len(m.RunningDirectives) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.RunningDirectives[iNdEx]).(interface {
	...
	if len(m.RunningControllers) > 0 {
		for iNdEx := len(m.RunningControllers) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.RunningControllers[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
