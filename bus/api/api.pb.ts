...
export const GetBusInfoResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetBusInfoResponse>, I>>(
    ...
    message.runningControllers =
      object.runningControllers?.map((e) => Info.fromPartial(e)) || []
    message.runningDirectives =
      object.runningDirectives?.map((e) => DirectiveState.fromPartial(e)) || []
    return message
  },
}
...
export class ControllerBusServiceClientImpl implements ControllerBusService {
  ...
  GetBusInfo(request: GetBusInfoRequest): Promise<GetBusInfoResponse> {
    ...
    return promise.then((data) =>
      GetBusInfoResponse.decode(new _m0.Reader(data))
    )
  }
...
/** ControllerBusService is a generic controller bus lookup api. */
export type ControllerBusServiceDefinition =
  typeof ControllerBusServiceDefinition
