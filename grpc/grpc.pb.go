...
func (*GetBusInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_a50c8bc37a1b7255, []int{0}
}
...
func (*GetBusInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_a50c8bc37a1b7255, []int{1}
}
...
func (*DirectiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_a50c8bc37a1b7255, []int{2}
}
...
func (*DebugValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_a50c8bc37a1b7255, []int{3}
}
...
// Client API for ControllerBusService service
...
func (c *controllerBusServiceClient) GetBusInfo(ctx context.Context, in *GetBusInfoRequest, opts ...grpc.CallOption) (*GetBusInfoResponse, error) {
	...
	err := grpc.Invoke(ctx, "/controllerbus.grpc.ControllerBusService/GetBusInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for ControllerBusService service
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/controllerbus/grpc/grpc.proto", fileDescriptor_grpc_a50c8bc37a1b7255)
}

var fileDescriptor_grpc_a50c8bc37a1b7255 = []byte{
