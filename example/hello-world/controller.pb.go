...
func (m *ToyControllerConfig) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (m *ToyControllerConfig) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: ToyControllerConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: ToyControllerConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
