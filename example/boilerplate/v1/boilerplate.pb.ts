...
export const Boilerplate = {
  encode(message: Boilerplate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<Boilerplate | Boilerplate[]> | Iterable<Boilerplate | Boilerplate[]>,
  ...
  fromJSON(object: any): Boilerplate {
    return { messageText: isSet(object.messageText) ? String(object.messageText) : "" };
  },
...
export const BoilerplateResult = {
  encode(message: BoilerplateResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<BoilerplateResult | BoilerplateResult[]> | Iterable<BoilerplateResult | BoilerplateResult[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): BoilerplateResult {
    return { printedLen: isSet(object.printedLen) ? Number(object.printedLen) : 0 };
  },
