...
func (m *Boilerplate) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: Boilerplate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: Boilerplate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field MessageText", wireType)
			}
...
func (m *BoilerplateResult) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: BoilerplateResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: BoilerplateResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field PrintedLen", wireType)
			}
			m.PrintedLen = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
